    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection cn = new SqlConnection(connectionstring))
            {
                ...
                string query = "SELECT ADMINEMAIL, PASSWORD FROM ADMIN WHERE ADMINEMAIL = @ADMINEMAIL AND PASSWORD = @PASSWORD";
        ...
        protected void btnSignUp_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                using (SqlConnection cn = new SqlConnection(connectionstring))
                {
                    string query = "INSERT INTO ADMIN (FULLNAME, ADMINEMAIL, PASSWORD) VALUES (@FULLNAME, @ADMINEMAIL, @PASSWORD)";
                    using (SqlCommand cmd = new SqlCommand(query, cn))
                    {
                        cn.Open();
                        cmd.Parameters.AddWithValue("@FULLNAME", regname.Text);
                        cmd.Parameters.AddWithValue("@ADMINEMAIL", regemail.Text);
